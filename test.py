if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='D:\EE\ETH\project\BrainGNN\data\ABIDE_pcp\cpac\\filt_noglobal',
    ...
    parser.add_argument('--layer', type=int, default=2, help='number of GNN.py layers')
    ...
    tr_index, val_index, te_index = np.array(train_val_test_split(fold=fold))
    ...
    if opt_method == 'Adam':
        ...
        optimizer = torch.optim.SGD(model.parameters(), lr=opt.lr, momentum=0.9, weight_decay=opt.weightdecay,
                                    nesterov=True)
